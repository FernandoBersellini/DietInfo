...
public class GetUserServiceTest {
    ...
    public void given_user_exists_when_get_user_service_return_user_dto() {
        ...
        ResponseEntity<UserDTO> responseEntity = userService.getUserById(1);
    ...
    @Test
    public void given_user_does_not_exist_when_get_user_service_throw_new_user_not_found_exception() {
